...
extension Color {
    ...
    static let farmBgGradientTop = Color(red: 0.94, green: 0.96, blue: 0.91)
    static let farmBgGradientBottom = Color(red: 0.98, green: 0.96, blue: 0.92)
    static let farmText = Color(red: 0.25, green: 0.25, blue: 0.25)        // Dark gray for body text
    static let farmTextLight = Color(red: 0.40, green: 0.40, blue: 0.40)   // Medium gray for subtitles
}
